...
public class DoneNotifications extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.done_notifications);
                ...
                for (DataSnapshot child: snapshot.getChildren()) {
                    ...
                    userRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if(String.valueOf(child.child("pending").getValue()).equals("1")) {
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent walkPage = new Intent(DoneNotifications.this, DonePage.class);
